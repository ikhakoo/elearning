...
* Admin can upload new instructors into the system - DONE
...
1. Update content on landing page - DONE

2. Disable Learn-IT button on landing page

3. Notice messages need to be reviewed; they are popping in unexpecting places and ways

4. Course show page for visitors needs styling - DONE

5. Remove the Track Record button (for all users) - DONE

6. Add next page links, back button link, done button link at the button of the lesson/chapter pages - DONE

7. Tracking progress needs to be completed - DONE
