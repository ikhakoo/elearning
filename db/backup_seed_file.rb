...
@aroswell aroswell
 ...
 Unwatch 4
  Star 0
 Fork 0ikhakoo/elearning
 branch: master  elearning/db/seeds.rb
@ikhakooikhakoo 3 hours ago add web dev immersive class to seed
4 contributors @ikhakoo @warrenphen @danieldvorkin @aroswell
RawBlameHistory     1317 lines (966 sloc)  48.765 kB
